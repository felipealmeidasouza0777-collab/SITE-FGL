  ...
  return (
    <>
      ...
      <style>{`
        ...
        .animate-chat-bubble {
          animation: popInAndFloat 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }
      ...
      <div className="fixed bottom-6 right-6 z-50 flex items-center animate-container-float">
        <a
          href={WHATSAPP_URL}
          target="_blank"
